...
class _ClientApi implements ClientApi {
  ...
  Future<MultiLanguageItemDescriptionSelectInfoResponse>
    ...
    final _data = itemId;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<MultiLanguageItemDescriptionSelectInfoResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/json',
            ...
            .compose(
              _dio.options,
              'MultiLanguageItemDescriptionSelect',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final value =
        MultiLanguageItemDescriptionSelectInfoResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<MultiLanguageItemIntroLinkSelectInfoResponse>
    ...
    final _data = itemId;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<MultiLanguageItemIntroLinkSelectInfoResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/json',
            ...
            .compose(
              _dio.options,
              'MultiLanguageItemIntroLinkSelect',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
