  ...
  for (int i = 0; i < types.length; i++) {
    ...
    widgets.add(Flexible(
      child: Padding(
        ...
        child: _BenefitItem(type, screenStyle: ScreenStyle.desktop),
      ),
    ));
  }
  return widgets;
...
List<Widget> get benefitTabletWidget {
  ...
  for (int i = 0; i < types.length; i++) {
    ...
    widgets.add(
      Flexible(
        child: _BenefitItem(type, screenStyle: ScreenStyle.tablet),
      ),
    );
  }
  return widgets;
...
List<Widget> get benefitMobileWidget {
  ...
  for (int i = 0; i < types.length; i++) {
    ...
    widgets.add(Padding(
      ...
      child: _BenefitItem(type, screenStyle: ScreenStyle.mobile),
    ));
  }
  return widgets;
}
